...
This is a 11ty project for a website that is designed to teach technical concepts and techniques to students in the Swedish gymnasieskola. The website is based on a template that can cover a wide range of topics, but this particular version focuses on frontend web development. The content is structured based on themes, topics and parts, and includes excercises, questions and projects to help students learn.
